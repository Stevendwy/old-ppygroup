...
export default class Modal extends Component {
	...
	render() {
		...
		// let _content = this.props.type == 0 ? <ModalBodyMain list={this.state.list[1]} /> : <ModalMiMain list={this.state.list[2]} listfirst={this.state.list[1]}/>
		let _content = this.props.type == 0 ? <ModalMiMain list={this.state.list[2]} listfirst={this.state.list[1]} /> : <ModalMiMain list={this.state.list[2]} listfirst={this.state.list[1]}/>
		return (
